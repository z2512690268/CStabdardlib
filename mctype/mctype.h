/*
* @Author: GUNK
* @Date:   2020-12-29 15:23:00
* @Last Modified by:   GUNK
* @Last Modified time: 2020-12-29 20:43:07
* @Edited with: sublime Text 3
* @Language: cpp
* @descriptions:my ctype.h
*/
...
#define isgraph(c) (_Ctype[(int)(c)] & (_DI|_LO|_UP|_PU|_XA))
#define islower(c) (_Ctype[(int)(c)] & (_LO))
#define isprint(c) (_Ctype[(int)(c)] & (_DI|_LO|_UP|_PU|_XA|_SP))
